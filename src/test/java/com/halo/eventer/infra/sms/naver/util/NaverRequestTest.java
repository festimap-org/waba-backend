...
public class NaverRequestTest {
    ...
    void 빌드_성공하면_유효한_HttpEntity_반환()  throws Exception {
        ...
        assertThat(headers).containsKeys("x-ncp-iam-access-key", "x-ncp-apigw-timestamp",
                "x-ncp-apigw-signature-v2");

        Map<String, Object> payload = mapper.readValue(entity.getBody(),
        ...
        assertThat(msgList.get(0))
                .containsEntry("to", "01011111111")
                .containsEntry("content", "message");
        assertThat(msgList.get(1))
                .containsEntry("to", "01022222222")
                .containsEntry("content", "message");
    }
}
