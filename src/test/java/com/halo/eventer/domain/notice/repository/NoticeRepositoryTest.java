...
public class NoticeRepositoryTest {
    ...
    void index_기반_페이징_첫_페이지_조회(){
        ...
        // when
        List<Notice> firstPage = noticeRepository
                .getNoticesNextPageByFestivalIdAndLastValue(festival.getId(), ArticleType.NOTICE.name(),
                        LocalDateTime.of(9999, 12, 31, 23, 59, 59),0L,5);
    ...
    void index_기반_페이징_N번째_페이지_조회(){
        ...
        Notice noticeId7 = noticeRepository.findById(n.getId())
                .orElseThrow(() -> new IllegalStateException("ID 7 not found"));
