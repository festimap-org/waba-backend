...
public class SquareWidgetControllerTest {
    ...
    void 정사각형위젯_생성_테스트() throws Exception{
        ...
        given(squareWidgetService.create(eq(1L),any(SquareWidgetCreateDto.class))).willReturn(squareWidgetResDto);
        ...
        verify(squareWidgetService,times(1))
                .create(eq(festivalId), any(SquareWidgetCreateDto.class));
    }
    ...
    void 정사각형위젯_단일조회()throws Exception{
        ...
        //when & then
        mockMvc.perform(get("/api/squareWidgets/{id}",1L)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(1L))
                .andExpect(jsonPath("$.name").value(squareWidgetCreateDto.getName()))
                ...
                .andExpect(jsonPath("$.displayOrder").value(11));
        verify(squareWidgetService,times(1))
                .getSquareWidget(eq(squareWidgetId));
    }
    ...
    void 정사각형위젯_리스트_조회()throws Exception{
        ...
        given(squareWidgetService.getSquareWidgetsWithOffsetPaging(eq(festivalId),any(SortOption.class),
    ...
    void 정사각형위젯_수정() throws Exception {
        ...
        mockMvc.perform(patch("/api/squareWidgets")
                ...
                .andExpect(jsonPath("$.displayOrder").value(11));
        verify(squareWidgetService,times(1))
                .update(eq(squareWidgetId),any(SquareWidgetCreateDto.class));
    }
