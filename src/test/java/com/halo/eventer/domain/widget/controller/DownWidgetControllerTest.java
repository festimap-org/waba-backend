...
public class DownWidgetControllerTest {
    ...
    void 하단위젯_생성_테스트() throws Exception{
        ...
        verify(downWidgetService,times(1))
                .create(eq(festivalId), any(DownWidgetCreateDto.class));
    }
    ...
    void 하단위젯_리스트_조회()throws Exception{
        ...
        //when & then
        mockMvc.perform(get("/api/downWidgets")
                        .param("festivalId","1")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
        ...
        verify(downWidgetService,times(1))
                .getAllDownWidgets(eq(festivalId));
    }
    ...
    void 하단위젯_수정() throws Exception {
        ...
        given(downWidgetService.update(eq(downWidgetId),any(DownWidgetCreateDto.class))).willReturn(downWidgetResDto);
        ...
        mockMvc.perform(patch("/api/downWidgets")
                ...
                .andExpect(jsonPath("$.displayOrder").value(11));
        verify(downWidgetService,times(1))
                .update(eq(downWidgetId),any(DownWidgetCreateDto.class));
    }
