...
public class VoteController {
  ...
  public VoteGetResDto updateVote(
      @PathVariable("voteId") Long voteId, @RequestBody VoteUpdateReqDto voteUpdateReqDto) {
    return new VoteGetResDto(voteService.updateVote(voteId, voteUpdateReqDto));
  }

  /** 투표 삭제 ( 백오피스 용) */
  @DeleteMapping("/vote/backOffice/{voteId}")
  public VoteBackOfficeListDto deleteVote(
      @PathVariable("voteId") Long voteId, @RequestParam("festivalId") Long festivalId) {
  ...
  public VoteLikeUlidResDto increaseLikeCnt(
