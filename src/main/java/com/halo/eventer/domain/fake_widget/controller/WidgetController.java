package com.halo.eventer.domain.fake_widget.controller;

import com.halo.eventer.domain.fake_widget.dto.WidgetDto;
import com.halo.eventer.domain.fake_widget.dto.WidgetGetListDto;
import com.halo.eventer.domain.fake_widget.service.WidgetService;
import com.halo.eventer.domain.fake_widget.swagger.WidgetGetApi;
import com.halo.eventer.domain.fake_widget.swagger.WidgetGetListApi;
...
public class WidgetController {
  ...
  public SuccessResponse crateWidget(
      @PathVariable Long festivalId, @RequestBody WidgetDto widgetDto) {
  ...
  public String updateWidget(
      @RequestParam("widgetId") Long widgetId, @RequestBody WidgetDto widgetDto) {
