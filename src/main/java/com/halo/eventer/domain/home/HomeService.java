...
public class HomeService {
    ...
    public HomeDto getMainPage(Long festivalId) throws NoDataInDatabaseException {
        List<RegisteredBannerGetListDto> banner = noticeRepository.findAllByPickedAndFestival_Id(true,festivalId).stream().map(RegisteredBannerGetListDto::new).collect(Collectors.toList());
