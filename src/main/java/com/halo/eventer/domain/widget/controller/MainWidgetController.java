...
public class MainWidgetController {
    ...
    @PostMapping()
    public MainWidgetResDto create(@RequestParam Long festivalId,
                                   @RequestBody MainWidgetCreateDto mainWidgetCreateDto) {
    ...
    @PatchMapping()
    public MainWidgetResDto update(@RequestParam Long id,
                                   @RequestBody MainWidgetCreateDto mainWidgetCreateDto) {
