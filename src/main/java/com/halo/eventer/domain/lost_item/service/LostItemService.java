...
public class LostItemService {
    ...
    public LostItem updateLostItem(Long id, LostItemDto lostDto) {
        LostItem item = lostItemRepository.findById(id).orElseThrow(()->new BaseException("해당 분실물이 존재하지 않습니다.", ErrorCode.ELEMENT_NOT_FOUND));
    ...
    public void deleteLostItem(Long id){
        lostItemRepository.delete(lostItemRepository.findById(id).orElseThrow(()->new BaseException("해당 분실물이 존재하지 않습니다.", ErrorCode.ELEMENT_NOT_FOUND)));
    }
    //분실물 단일 조회
