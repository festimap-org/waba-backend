...
public class ConcertInfoService {
    ...
    /** 공연 정보 생성 */
    @Transactional
    public String createInfoName(Long festivalId,String name, ConcertInfoType type) throws BaseException {
    ...
    /** 타입 별 공연 정보 전체 조회 */
    public ConcertInfoGetListDto getConcertInfoListByType(Long festivalId, ConcertInfoType type) throws BaseException {
    ...
    /** 단일 공연 정보 조회 */
    public ConcertInfo getConcertInfo(Long concertId) throws BaseException {
    ...
    /** 상세 이미지 등록 */
    @Transactional
    public String updateConcertInfo(Long concertInfoId, ConcertInfoUpdateDto concertUpdateDto) throws BaseException {
        ConcertInfo concertInfo = concertInfoRepository.findById(concertInfoId).orElseThrow(()->new NoDataInDatabaseException("공연 부가 정보가 존재하지 않습니다."));
