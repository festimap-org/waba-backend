...
public class StampUserController {
  ...
  public StampUserGetDto signup(
      @RequestParam("stampId") Long stampId,
      @RequestBody SignupWithoutCustomDto signupWithoutCustomDto) {
  ...
  public StampUserGetDto login(
      @RequestParam("stampId") Long stampId, @RequestBody LoginDto loginDto) {
